...
def usage():
    ...
    print "-l --listen               --> sniffering the inbound connections"
    print "-e --execute=file_to_run  --> executing the designated file when connection established"
    ...
    print
    print "bhpnet quit               --> (client) disconnects from target"
    print
    print "Examples:"
    print "bhpnet.py -t 192.168.0.1 -p 5555 -l -c"
    print "bhpnet.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe"
    print "bhpnet.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\""
    print "echo 'Hello' | ./bhpnet.py -t 192.168.11.12 -p 135"
    print "./bhpnet.py -t 192.168.11.12 -p 135 -c"
    sys.exit(0)
